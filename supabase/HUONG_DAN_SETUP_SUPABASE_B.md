# HƯỚNG DẪN CÀI ĐẶT SUPABASE CHO CÔNG TY 22 (DỰ ÁN MỚI)
...
2. Bấm **New project** → Đặt tên (VD: `HR-Company-22`) → Chọn database password → Chọn Region gần (Singapore).
...
2. Mở file [01_schema_company_b.sql](file:///d:/hr/HR-Company-22/supabase/01_schema_company_b.sql):
...
3. Mở file [02_seed_demo_b.sql](file:///d:/hr/HR-Company-22/supabase/02_seed_demo_b.sql):
   - Copy toàn bộ nội dung dán vào SQL Editor.
   - Bấm **Run**.
...
3. Mở file [d:/hr/HR-Company-22/.env](file:///d:/hr/HR-Company-22/.env) và dán thông tin vào:
   ```env
   VITE_SUPABASE_URL="https://abcdefghijklmnop.supabase.co"
   VITE_SUPABASE_ANON_KEY="sb_publishable_..."
   VITE_DEFAULT_COMPANY_ID="00000000-0000-0000-0000-000000000022"
   ```

---

### Bước 4: Khởi chạy Dự án
Mở terminal tại thư mục `d:\hr\HR-Company-22` và chạy:
```bash
npm run dev
```
Dự án sẽ khởi chạy và kết nối trực tiếp đến Supabase mới của Công ty 22.
